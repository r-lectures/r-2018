...
2. i)  Bajarse el Quijote de Project Gutenberg en formato "Plain Text UTF-8" (o sea, formato texto o
   ASCII)
   ii) Meter el libro entero en un vector character, o sea, una palabra por en cada elemento del vector. Tip: stringr::str_split 
   iii) Usar group_by y summarise para contar cuantas veces aparece cada palabra. Tip: buenos
